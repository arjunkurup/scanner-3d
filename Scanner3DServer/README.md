...
To build
docker build . -t scanner3d-backend

To run
docker run -it -p 5000:5000 --entrypoint bash -v /Users/arjunkurup/Development/sfm-data:/source/OpenSfM/static/sfm-data scanner3d-backend
